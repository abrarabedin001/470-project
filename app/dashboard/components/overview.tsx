  ...
  <table className="owcustom-table-white dark:owcustom-table text-gray-700 dark:text-silver-700 rounded-2xl">
    <thead className="">
      <tr className="rounded-xl">
        ...
        <th className="owtable-header-light dark:owtable-header" style={{ width: '18%' }}>
          Status
        </th>
        <th className="owtable-header-light dark:owtable-header custom-head-2" style={{ width: '34%' }}>
          CreatedAt
        </th>
      </tr>
    </thead>
    <tbody>
      {tasks.map((task, index) => (
        <tr key={index} className="border divide-y divide-solid divide-x">
          ...
          <td className="text-center owtable-body text-black dark:text-white" style={{ width: '18%' }}>
            {task.status}
          </td>
          <td className="text-center owtable-body text-black dark:text-white" style={{ width: '34%' }}>
